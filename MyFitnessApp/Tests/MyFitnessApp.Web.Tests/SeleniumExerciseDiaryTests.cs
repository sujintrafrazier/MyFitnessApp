...
public class ExerciseDiaryTests : IDisposable
{
    ...
    [Fact]
    public void TestInvalidRepetitions()
    {
        this._driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(10);
        this._driver.Navigate().GoToUrl(this._url + "Exercises/All");
        this._driver.Navigate().GoToUrl(this._url + "Exercises/Add/58");
        ...
        var repsErrorMessage = wait.Until(d => d.FindElement(By.CssSelector("span[data-valmsg-for='Repetitions']"))).Text;

        Assert.Equal("The value must be between 1 and 100", repsErrorMessage);
    ...
    public void TestInvalidSets()
    {
        this._driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(10);
        this._driver.Navigate().GoToUrl(this._url + "Exercises/All");
        this._driver.Navigate().GoToUrl(this._url + "Exercises/Add/57");
        ...
        var setsErrorMessage = wait.Until(d => d.FindElement(By.CssSelector("span[data-valmsg-for='Sets']"))).Text;

        Assert.Equal("The value must be between 1 and 100", setsErrorMessage);
